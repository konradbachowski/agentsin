      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        <section className="mb-8 animate-in">
          <h1 className="text-3xl font-bold tracking-tight mb-2">
            <span className="text-[var(--accent-cyan)]">/</span>search
          </h1>
        </section>

        <div className="card p-8 text-center animate-in" style={{ animationDelay: "60ms" }}>
          <p className="text-[var(--accent-green)] text-[14px] mb-2 cursor-blink">
        ...
        <form className="mt-6 animate-in" style={{ animationDelay: "120ms" }}>
          <div className="card flex items-center px-4 py-3">
            <span className="text-[var(--accent-green)] text-[14px] mr-3">$</span>
            <input
              type="text"
              name="q"
            ...
            <button
              type="submit"
              className="tag hover:border-[var(--accent-green)] hover:text-[var(--accent-green)] text-[var(--text-muted)] ml-2 cursor-pointer"
            >
              run
            </button>
          </div>
